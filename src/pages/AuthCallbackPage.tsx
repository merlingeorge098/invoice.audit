...
import { ArrowLeft, ArrowRight, Building2, LoaderCircle, ShieldCheck } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent } from "@/components/ui/card";
import { completeEnterpriseAuth } from "@/lib/auth";
import { useAuthSession } from "@/lib/auth-session-context";
import { authPaths, demoPaths, entryPath } from "@/lib/workspace";
...
export default function AuthCallbackPage() {
  ...
  useEffect(() => {
    if (!authRequestId) {
      setStatus("error");
      setError("The mock callback is missing the auth request reference.");
      return;
    }
